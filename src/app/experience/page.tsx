  ...
  return (
    <>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-6 border rounded-lg shadow-sm">
              <div className="text-4xl font-bold text-blue-600 mb-2">{experienceData.experience.length}</div>
      ...
      <section className="py-12 px-6 bg-gray-50">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Career Summary</h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-3xl font-bold text-center mb-16">Career Timeline</h2>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-3xl font-bold text-center mb-12">Leadership & Certifications</h2>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">2014 Ronald Reagan Leadership Award Winner</span>
                </li>
                <li className="flex items-start">
                  <div className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
                    <div className="w-2.5 h-2.5 rounded-full bg-green-600"></div>

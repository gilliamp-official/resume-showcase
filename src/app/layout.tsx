...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} font-sans min-h-screen bg-gradient-to-br from-gray-50 to-blue-50`}>
        <Navbar />
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
              <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-6">
                ...
                <Link href="https://theproductpipeline.substack.com" className="hover:text-white transition-colors">Substack</Link>
